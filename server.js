...
FRIEND_LIST_PORT=process.env.FRIEND_LIST_PORT
LIST_PORT=process.env.LIST_PORT
SEARCH_PORT=process.env.SEARCH_PORT
CHATFRIENDS_PORT=process.env.CHATFRIENDS_PORT
PORT_ONE=process.env.PORT_ONE
PORT_ELEVEN=process.env.PORT_ELEVEN
PORT_FIVE=process.env.PORT_FIVE
PORT_FIFTY_FIVE=process.env.PORT_FIFTY_FIVE
